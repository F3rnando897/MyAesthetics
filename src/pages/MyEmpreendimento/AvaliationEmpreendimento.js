...
import { styles } from './styles/Avaliationstyle';
import Avatar from '../../../assets/Icons/avatar.png';
const AvaliationEmpreendimento = ({ route }) => {
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.avaliationsItem}>
            <Image
              source={{ uri: item.userAvaliationId.imgProfile ? item.userAvaliationId.imgProfile.url : Avatar }}
              style={[styles.userImg, { marginTop: 9 }]}
            />
...
export default AvaliationEmpreendimento;
